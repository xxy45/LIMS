...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                <li>
                    <a href="#" class="active-menu waves-effect waves-dark"><i class="fa fa-dashboard"></i> 图书管理</a>
    ...
    <div id="page-wrapper">
        ...
        <div class="search d1">
	  <form action="TBook/search1.jsp" name="f1" method="POST" target="iframepage" onsubmit = "return checkText1();">
                <input type="text"  placeholder="搜索书名..." id = "search1" name="s1">
                <button type="submit" ></button>
	  </form>
	  <form action="TBook/search2.jsp" name="f2" method="POST" target="iframepage" onsubmit = "return checkText2();">
                <input type="text"  placeholder="搜索分类号..." id= "search2" name="s2">
                <button type="submit"></button>
	  </form>
        ...
        <div id="page-inner">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                       <iframe src="TBook/TBook_admin.jsp" id="iframepage"
