...
<ul id="dropdown1" class="dropdown-content">
    <li><a href="dousercenter.jsp"><i class="fa fa-user fa-fw"></i> 个人信息</a>
    </li>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="#" class="active-menu waves-effect waves-dark"><i class="fa fa-dashboard"></i> 图书查询</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                            <%=session.getAttribute("name") %> <small>查询</small>
                        </h1>					 
		</div>
	<div class="search d1">
	  <form action="common/do1.jsp" name="f2" method="POST" target="iframepage" >
            ...
            <div id="page-inner"> 
			  ...
			  <div class="row">
                    ...
                    <div class="col-md-12">
                    <div class="card">
                        <iframe src="common/TBook.jsp" id="iframepage"
