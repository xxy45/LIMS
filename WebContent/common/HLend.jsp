...
%>
 ...
 <form name="f1" action="HLend.jsp" method="POST"  onSubmit="return checknum()">
            <table border="0" align="center" >
                <tr>
                    <td>第<%=pages %> 页 共<%=totalpages %>页 <a href="HLend.jsp?pages=1">首页</a></td>
                    <td><a href="Hlend.jsp?pages=<%=(pages<1)?pages:(pages-1) %>"> 上一页</a></td>
                    <td><a href="HLend.jsp?pages=<%=(pages>=totalpages)?totalpages:(pages+1)%>"> 下一页</a></td>
                    <td><a href="HLend.jsp?pages=<%=totalpages%>">最后一页</a></td>
