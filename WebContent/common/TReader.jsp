<%@ page language="java" import="java.util.*" import="java.sql.*" contentType="text/html; charset=UTF-8"
   ...
   <%int pages = 1;
    ...
    rs= stmt.executeQuery("select count(*) from HLend");
    if(rs.next()){
...
%>
 ...
 <form name="f1" action="TReader.jsp" method="POST"  onSubmit="return checknum()">
            <table border="0" align="center" >
                <tr>
                    <td>第<%=pages %> 页 共<%=totalpages %>页 <a href="TReader.jsp?pages=1">首页</a></td>
                    <td><a href="TReader.jsp?pages=<%=(pages<1)?pages:(pages-1) %>"> 上一页</a></td>
                    <td><a href="TReader.jsp?pages=<%=(pages>=totalpages)?totalpages:(pages+1)%>"> 下一页</a></td>
                    <td><a href="TReader.jsp?pages=<%=totalpages%>">最后一页</a></td>
