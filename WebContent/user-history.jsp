        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="#" class="active-menu waves-effect waves-dark"><i class="fa fa-dashboard"></i> 借书历史</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                      		 <%=session.getAttribute("name") %> <small>借书历史</small>
                        </h1>
            ...
            <div id="page-inner"> 
			  ...
			  <div class="row">
                    ...
                    <div class="col-md-12">
                    <div class="card">
                        <iframe src="common/borrow_history.jsp" id="iframepage"
