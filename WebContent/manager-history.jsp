...
<div id="wrapper">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
               ...
               <li>
                ...
                <li>
                    <a href="#" class="active-menu waves-effect waves-dark"><i class="fa fa-qrcode"></i> 借书情况查询</a>
                </li>
                <li>
    ...
    <div id="page-wrapper">
	    ...
	    <div class="search d1">
	  <form action="common/search7.jsp" name="f7" method="POST" target="iframepage" onsubmit = "return checkText7();">
                <input type="text"  placeholder="搜索ISBN..." id = "search7" name="s7">
                <button type="submit" ></button>
	  </form>
	  <form action="common/search8.jsp" name="f8" method="POST" target="iframepage" onsubmit = "return checkText8();">
                <input type="text"  placeholder="搜索借书证号..." id= "search8" name="s8">
                <button type="submit"></button>
	  </form>
				<script language="javascript">
					function checkText7(){
						var text = document.getElementById("search7").value;
						if(text=="") return false;
						else return true;
					}
					
					function checkText8(){
					var text = document.getElementById("search8").value;
					if(text=="") return false;
					else return true;
				}
				</script>
        ...
        <div id="page-inner">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <iframe src="common/lend_history.jsp" id="iframepage"
