...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
               ...
               <li>
                    <a href="#" class="active-menu waves-effect waves-dark"><i class="fa fa-bar-chart-o"></i> 在借图书查询</a>
                </li>
                <li>
    ...
    <div id="page-wrapper">
        ...
        <div class="search d1">
	  <form action="common/search5.jsp" name="f5" method="POST" target="iframepage" onsubmit = "return checkText5();">
                <input type="text"  placeholder="搜索ISBN..." id = "search5" name="s5">
                <button type="submit" ></button>
	  </form>
	  <form action="common/search6.jsp" name="f6" method="POST" target="iframepage" onsubmit = "return checkText6();">
                <input type="text"  placeholder="搜索借书证号..." id= "search6" name="s6">
                <button type="submit"></button>
	  </form>
				<script language="javascript">
					function checkText5(){
						var text = document.getElementById("search5").value;
						if(text=="") return false;
						else return true;
					}
					
					function checkText6(){
					var text = document.getElementById("search6").value;
					if(text=="") return false;
					else return true;
				}
				</script>
        ...
        <div id="page-inner">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                       <iframe src="common/have_lended.jsp" id="iframepage"
